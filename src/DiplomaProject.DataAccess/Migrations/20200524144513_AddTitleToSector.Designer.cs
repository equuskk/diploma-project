...
namespace DiplomaProject.DataAccess.Migrations
{
    ...
    [Migration("20200524144513_AddTitleToSector")]
    partial class AddTitleToSector
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiplomaProject.Domain.Entities.Station", b =>
                {
                    ...
                    b.Property<int>("PrimingId")
                        .HasColumnType("integer");

                    b.Property<int>("SectorId")
                        .HasColumnType("integer");

                    b.Property<int>("ThicketTypeId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DiplomaProject.Domain.Entities.ThicketType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DiplomaProject.Domain.Entities.Sector", b =>
                {
                    b.HasOne("DiplomaProject.Domain.Entities.Litoral", null)
                        .WithMany("Sectors")
            ...
            modelBuilder.Entity("DiplomaProject.Domain.Entities.Station", b =>
                {
                    ...
                    b.HasOne("DiplomaProject.Domain.Entities.ThicketType", "ThicketType")
                        .WithMany()
                        .HasForeignKey("ThicketTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
